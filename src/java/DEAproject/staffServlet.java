...
public class staffServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String cpwd = request.getParameter("cps");
        int phoneno = Integer.parseInt(request.getParameter("phone"));
        
        Login l=new Login();
        l.staffLogin(uname,mail,pwd,cpwd,phoneno);
        
        //connect to the jsp
        List slist= l.checkstaff(uname);
        request.setAttribute("loginresult", slist);
        RequestDispatcher rd= request.getRequestDispatcher("staffDash.jsp");
